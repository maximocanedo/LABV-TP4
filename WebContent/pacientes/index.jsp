...
<body>
    ...
    <main id="container-md">
            ...
            <div class="col-12 w-100">
                <div class="container justify-content-end">
                    <div class="d-flex" role="search">
                        ...
                        <button class="btn btn-outline-primary" type="button" id="btnAddPatient" onclick="location.href='/pacientes/manage/index.html';">Agregar</button>
                    </div>
                </div>
        ...
        <div class="row mt-3">
            ...
            <div class="col text-center" id="tableContainer">
                <table id="tableListadoPacientes" class="display" style="width:100%"></table>
    ...
    <script type="module" src="../api/controller/pacientes/index.js"></script>
</body>
