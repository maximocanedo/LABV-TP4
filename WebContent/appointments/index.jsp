...
<body>
    ...
    <main id="container-md">
        <div class="row">
            ...
            <div class="col w-100">
                <div class="d-flex" role="search">
                    <select class="form-select me-2" style="width: 80px;" aria-label="Default select example"
                        id="ddlEntriesPerPage">
                        <option value="10" selected>10</option>
                        <option value="25">25</option>
                        <option value="50">50</option>
                    </select>
                    <select class="form-select me-2" style="width: 140px;" aria-label="Default select example"
                        id="ddlStatusFilterAppointment">
                        <option value="PENDING" selected>PENDIENTES</option>
                        <option value="ABSENT">AUSENTES</option>
                        <option value="PRESENT">PRESENTES</option>
                    </select>
                    <input class="form-control me-2" type="search" id="txtBuscar" placeholder="Buscar..."
                        aria-label="Search">
        ...
        <div class="row mt-3">
            ...
            <div class="col text-center" id="tableContainer">
                <table id="tableListadoAppointments" class="display" style="width:100%"></table>
    ...
    <script type="module" src="../api/controller/appointments/index.js"></script>
</body>
